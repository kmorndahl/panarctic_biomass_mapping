...
# Topographic data, based on Copernicus DEM, 30m
slp = ee.ImageCollection('projects/arctic-biomass-mapping/assets/predictors/copernicus_30m_slope_gcs').mosaic()
asp = ee.ImageCollection('projects/arctic-biomass-mapping/assets/predictors/copernicus_30m_aspect_gcs').mosaic()
...
# Convert to radians
slp_rad = slp.multiply(3.14159265359).divide(180)
asp_rad = asp.multiply(3.14159265359).divide(180)
